...
public class RSAUtil {
    ...
    public static void main(String[] args) throws Exception {
        ...
        System.out.println("公钥：" + org.apache.commons.codec.binary.Base64.encodeBase64String(publicKey));
        System.out.println("私钥：" + org.apache.commons.codec.binary.Base64.encodeBase64String(privateKey));
        ...
        System.out.println("加密后的数据：" + org.apache.commons.codec.binary.Base64.encodeBase64String(code1));
        ...
        System.out.println("加密后的数据：" + org.apache.commons.codec.binary.Base64.encodeBase64String(code2));
