...
public class UrlValidator implements Serializable {
     ...
     * validation requirements you should create your checker with
     ...
     * Initialize a UrlValidator with the given validation options.
     *
     * @param authorityValidator Regular expression checker used to validate the authority part
