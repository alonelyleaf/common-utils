...
public class ServletUtil extends jodd.servlet.ServletUtil {
    ...
    public static String getRequestURI(ServletRequest request) {
        ...
        return request == null ? null : getRequest(request).getRequestURI();
    }
    ...
    public static String getMethod(ServletRequest request) {
        ...
        return request == null ? null : getRequest(request).getMethod();
    }
    ...
    public static Cookie[] getCookies(ServletRequest request) {
        ...
        return request == null ? null : getRequest(request).getCookies();
    }
    ...
    public static String getQueryString(ServletRequest request) {
        ...
        return request == null ? null : getRequest(request).getQueryString();
    }
    ...
    public static String getHeader(ServletRequest request, String name) {
        ...
        return request == null ? null : getRequest(request).getHeader(name);
    }
     ...
     * @return
     */
    public static String readRequestBody(ServletRequest request) throws IOException {

        return readRequestBodyFromReader((HttpServletRequest) request);
    }
}
