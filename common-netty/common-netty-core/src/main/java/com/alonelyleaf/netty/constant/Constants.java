package com.alonelyleaf.netty.constant;
...
public interface Constants {
    ...
    class ThreadNames {
        ...
        public static final String NS = "ts";
    ...
    class Command {
        ...
        public static final String CONNECT_HANDLER = "connectHandler";

        public static final String DEFAULT_HANDLER = "defaultHandler";

        public final static Map<Integer, String> COMMANDS = new HashMap() {
            {
                put(1, CONNECT_HANDLER);
            }
        };
    }
}
